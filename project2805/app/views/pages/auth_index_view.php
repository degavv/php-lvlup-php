<h1 class="admin-panel">Welcome to Admin-Panel</h1>
<form class='login-form' action="<?= app\core\Route::url('auth', 'login') ?>" method="post">
    <div class="flex-row">
        ...
        <input id="username" class='lf--input' placeholder='Username' type='text' name="login" required>
    </div>
    <div class="flex-row">
        ...
        <input id="password" class='lf--input' placeholder='Password' type='password' name="pass" required>
    </div>
    <input class='lf--submit' type='submit' value='LOGIN'>
</form>
<div class="error">
    <p><?= $_SESSION['error_login'] ?? '' ?></p>
    <?php app\core\Session::unset('error_login'); ?>
</div>