...
function PersonFarm() {
    ...
    this.secondNames = ['Prokopenko', 'Opanasenko', 'Shevchenko', 'Lysenko', 'Nikolenko', 'Zinchenko', 'Denysenko', 'Tymoshenko', 'Amosova', 'Pupko', 'Shmatko', 'Dmytrenko',];
...
for (let i = 0; i < 50; i++) {
    console.log(farm.getRandomInt(0, 9));
}
