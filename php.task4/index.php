<?php
// TODO Переробити з площі на периметр
...
$error_code = [
    "Значення не введено", 
    "Значення не може бути порожнє", 
    "Значення не має складатися з літер", 
    "Значення не може бути від'ємне", 
    "Значення не може бути нульовим", 
    "Значення не може бути більше 100",
];
